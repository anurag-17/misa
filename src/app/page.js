                  ...
                  {isSearchOpen && (
                    <div className="search-popup flex items-center">
                      <span className="close-icon" onClick={closeSearch}>
                        <Image
                          className="w-2 md:w-3 xl:w-4 2xl:w-6 xl:h-4 2xl:h-6"
                          src={xcross}
                          alt="cross"
                        />
                      </span>
                      <input
                        className="border w-20 md:w-24 xl:w-36 2xl:w-52 md:p-0 2xl:p-2 flex-grow" // Use flex-grow to allow the input to grow and take remaining space
                        type="text"
                        placeholder="Search..."
                        value={searchTerm}
          ...
          <div className="flex sm:flex-row flex-col  sm:items-center justify-between px-5 sm:px-5 md:px-12 lg:px-16 xl:px-24 2xl:px-28 mt-10 sm:mt-10 md:mt-12 lg:mt-14 xl:mt-16 2xl:mt-20">
            ...
            <div className="mt-4 sm:mt-0  relative w-[30%]">
              ...
              <Image
                ...
                src={arrow}
                alt="Right Arrow"
                className="absolute top-1/2 right-2 transform -translate-y-1/2 w-10 sm:w-5 "
              />
            </div>
          </div>
